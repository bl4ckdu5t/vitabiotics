...
(function() {
  ...
  ready = function() {
    $('[id^="edit_department"]').on("ajax:success", function(e, data, status, xhr) {
      $(this).append("<p class='fr'>Updated Succesfully</p>");
      return $(this).children('.fr').delay(2000).fadeOut();
    }).on("ajax:error", function(e, data, status, error) {
      $(this).append("<p class='fr'>Failed to update</p>");
    });
    return $('.new_announcement').on("ajax:success", function(e, data, status, xhr) {
      console.log('great');
